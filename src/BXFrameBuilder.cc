...
BXFrameBuilder::BXFrameBuilder( G4LogicalVolume * hall)
{
	frameLV = hall;
}
 
// Construction of the Blowfish support frame
G4int BXFrameBuilder::Build(G4bool frameUseWire)
{
	//------------------------------------------------------------------
	// Blowfish Frame
	//------------------------------------------------------------------
...
//simple rotation matricies
	...
	if(frameUseWire) frameAtt->SetForceWireframe(true); 
	else frameAtt->SetForceSolid(true); 
	...
	new G4PVPlacement(0,baseSupportZXaPos, baseSupportZXLV, "BaseSupportZXPhys", frameLV,false,0);
	new G4PVPlacement(0,baseSupportZYaPos, baseSupportZYLV, "BaseSupportZYPhys", frameLV,false,0);
	...
	new G4PVPlacement(0,baseSupportZXbPos, baseSupportZXLV, "BaseSupportZXPhys", frameLV,false,1);
	new G4PVPlacement(0,baseSupportZYbPos, baseSupportZYLV, "BaseSupportZYPhys", frameLV,false,1);
	...
	new G4PVPlacement(0,baseSupportXZaPos, baseSupportXZLV, "BaseSupportXZPhys", frameLV,false,0);
	new G4PVPlacement(0,baseSupportXYaPos, baseSupportXYLV, "BaseSupportXYPhys", frameLV,false,0);
	...
	new G4PVPlacement(0,baseSupportXZbPos, baseSupportXZLV, "BaseSupportXZPhys", frameLV,false,1);
	new G4PVPlacement(0,baseSupportXYbPos, baseSupportXYLV, "BaseSupportXYPhys", frameLV,false,1);
	...
	new G4PVPlacement(0,centerSupportZXPos,centerSupportZXLV,"CenterSupportZXPhys",frameLV,false,0);
	new G4PVPlacement(0,centerSupportZYPos,centerSupportZYLV,"CenterSupportZYPhys",frameLV,false,0);
	...
	new G4PVPlacement(0,vertSupportYZaPos, vertSupportYZLV, "VertSupportYZPhys",frameLV,false,0);
	new G4PVPlacement(0,vertSupportYXaPos, vertSupportYXLV, "VertSupportYXPhys",frameLV,false,0);
	...
	new G4PVPlacement(0,vertSupportYZbPos, vertSupportYZLV, "VertSupportYZPhys",frameLV,false,1);
	new G4PVPlacement(0,vertSupportYXbPos, vertSupportYXLV, "VertSupportYXPhys",frameLV,false,1);
	...
	new G4PVPlacement(0,vertSupportYZcPos, vertSupportYZLV, "VertSupportYZPhys",frameLV,false,2);
	new G4PVPlacement(0,vertSupportYXcPos, vertSupportYXLV, "VertSupportYXPhys",frameLV,false,2);
	...
	new G4PVPlacement(0,vertSupportYZdPos, vertSupportYZLV, "VertSupportYZPhys",frameLV,false,3);
	new G4PVPlacement(0,vertSupportYXdPos, vertSupportYXLV, "VertSupportYXPhys",frameLV,false,3);
	...
	new G4PVPlacement(rotm45z,angleSupportXYaPos, angleSupportXYLV,"AngleSupportXYPhys",frameLV,false,0);
	new G4PVPlacement(rotm45z,angleSupportXZaPos, angleSupportXZLV,"AngleSupportXZPhys",frameLV,false,0);
	...
	new G4PVPlacement(rotm45z,angleSupportXYbPos, angleSupportXYLV,"AngleSupportXYPhys",frameLV,false,1);
	new G4PVPlacement(rotm45z,angleSupportXZbPos, angleSupportXZLV,"AngleSupportXZPhys",frameLV,false,1);
	...
	new G4PVPlacement(rot45z,angleSupportXYcPos, angleSupportXYLV,"AngleSupportXYPhys",frameLV,false,2);
	new G4PVPlacement(rot45z,angleSupportXZcPos, angleSupportXZLV,"AngleSupportXZPhys",frameLV,false,2);
	...
	new G4PVPlacement(rot45z,angleSupportXYdPos, angleSupportXYLV,"AngleSupportXYPhys",frameLV,false,3);
	new G4PVPlacement(rot45z,angleSupportXZdPos, angleSupportXZLV,"AngleSupportXZPhys",frameLV,false,3);
	...
	new G4PVPlacement(0,crossSupportZYaPos, crossSupportZYLV, "CrossSupportZYPhys", frameLV,false,0);
	new G4PVPlacement(0,crossSupportZXaPos, crossSupportZXLV, "CrossSupportZXPhys", frameLV,false,0);
	...
	new G4PVPlacement(0,crossSupportZYbPos, crossSupportZYLV, "CrossSupportZYPhys", frameLV,false,1);
	new G4PVPlacement(0,crossSupportZXbPos, crossSupportZXLV, "CrossSupportZXPhys", frameLV,false,1);
	...
	new G4PVPlacement(rot90y, downHubMountPos, hubMountLV, "HubMountPhys",frameLV,false,0); 
	
	const G4ThreeVector upHubMountPos = G4ThreeVector(-hubMount_px,0.0,0.0) + origin;
	new G4PVPlacement(rot90y, upHubMountPos, hubMountLV, "HubMountPhys",frameLV,false,1); 
	...
	new G4PVPlacement(rot90y, downHubContPos, theHubBuilder.GetLVPointer(), "HubContPhys",frameLV,false,0); 

	const G4ThreeVector upHubContPos = G4ThreeVector(-hubCont_px,0.0,0.0) + origin;
	new G4PVPlacement(rot270y, upHubContPos, theHubBuilder.GetLVPointer(), "HubContPhys",frameLV,false,1); 
	...
	new G4PVPlacement(0,underSupportZXaPos, underSupportZXLV, "UnderSupportZXPhys", frameLV,false,0);
	new G4PVPlacement(0,underSupportZYaPos, underSupportZYLV, "UnderSupportZYPhys", frameLV,false,0);
	...
	new G4PVPlacement(0,underSupportZXbPos, underSupportZXLV, "UnderSupportZXPhys", frameLV,false,1);
	new G4PVPlacement(0,underSupportZYbPos, underSupportZYLV, "UnderSupportZYPhys", frameLV,false,1);
	...
	new G4PVPlacement(0,underSupportXZaPos, underSupportXZLV, "UnderSupportXZPhys", frameLV,false,0);
	new G4PVPlacement(0,underSupportXYaPos, underSupportXYLV, "UnderSupportXYPhys", frameLV,false,0);
	...
	new G4PVPlacement(0,underSupportXZbPos, underSupportXZLV, "UnderSupportXZPhys", frameLV,false,1);
	new G4PVPlacement(0,underSupportXYbPos, underSupportXYLV, "UnderSupportXYPhys", frameLV,false,1);
	...
	new G4PVPlacement(0,underSpaceraPos,underSpacerLV,"UnderSpaceraPhys",frameLV,false,0);
	new G4PVPlacement(0,underSpacerbPos,underSpacerLV,"UnderSpacerbPhys",frameLV,false,0);
	...
	new G4PVPlacement(rot315y,cornerSupportXZaPos,cornerSupportXZLV,"CornerSupportXZPhys", frameLV,false,0);
	new G4PVPlacement(rot225y,cornerSupportXZbPos,cornerSupportXZLV,"CornerSupportXZPhys", frameLV,false,1);
	new G4PVPlacement(rot45y ,cornerSupportXZcPos,cornerSupportXZLV,"CornerSupportXZPhys", frameLV,false,2);
	new G4PVPlacement(rot135y,cornerSupportXZdPos,cornerSupportXZLV,"CornerSupportXZPhys", frameLV,false,3);
	...
	new G4PVPlacement(rot315y,cornerSupportXYaPos,cornerSupportXYLV,"CornerSupportXYPhys", frameLV,false,0);
	new G4PVPlacement(rot225y,cornerSupportXYbPos,cornerSupportXYLV,"CornerSupportXYPhys", frameLV,false,1);
	new G4PVPlacement(rot45y ,cornerSupportXYcPos,cornerSupportXYLV,"CornerSupportXYPhys", frameLV,false,2);
	new G4PVPlacement(rot135y,cornerSupportXYdPos,cornerSupportXYLV,"CornerSupportXYPhys", frameLV,false,3);
	...
	new G4PVPlacement(0,powerSupplyPos,powerSupplyLV, "PowerSupplyPhys", frameLV, false, 0);
	...
	if(frameUseWire) powerSupplyAtt->SetForceWireframe(true);
	else powerSupplyAtt->SetForceSolid(true);
